...
$sql="UPDATE friendship SET status='Approved' WHERE frid='$frid'";
mysql_query($sql);
echo "Your friend had been added,click here to get back to MyPage."."<a href=\"mypage.php?uname=".$uname."\">Click Here</a>";
mysql_close($con);
?>
