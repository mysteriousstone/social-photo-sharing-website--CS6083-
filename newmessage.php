...
$text=$_POST["nm"];
$uname=$_SESSION['uname'];
$_SESSION['authoritymessage']=$_POST['authority'];
$authority=$_SESSION['authoritymessage'];
//mysql connect
$con = mysql_connect("localhost","web","lishi0");
if (!$con)
  {
...
$sql="INSERT INTO message (uname,text,mauthority) VALUES('$uname','$text','$authority')";
mysql_query($sql);
echo "Your message has been created,click here to view the latest messages."."<a href=\"mypage.php?uname=".$uname."\">Click Here</a>";
mysql_close($con);
?>