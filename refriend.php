...
<?php
$rfname=$_GET['rfname'];
$insert=mysql_query("UPDATE friendship SET status = 'approved' WHERE friendd='$uname' and userr='$rfname'and status='suspend'");
$addc1=mysql_query("INSERT INTO friend_circle VALUES ('$uname','$rfname','friend')");
$addc2=mysql_query("INSERT INTO friend_circle VALUES ('$rfname','$uname','friend')");
echo $rfname."&nbsp". "has become your friend";
