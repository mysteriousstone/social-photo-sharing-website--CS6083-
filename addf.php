...
<?php
$sql="INSERT INTO friendship VALUES ('$uname','$fname','suspend','','')";
mysql_query($sql);
echo "You have send a request for this user ,click here to get back to MyPage."."<a href=\"mypage.php?uname=".$uname."\">Click Here</a>";
mysql_close($con);
?>