...
<?php
$ph=mysql_query("SELECT psrc, pid, ptime, ploc, pname, pauthority FROM photo WHERE uname='$term' ORDER BY ptime DESC");
print mysql_error();
echo "<p style=\"font-family:verdana;font-size:100%;color:black\">"."My Photo".'<br/>'.'<br/>';
while($row1=mysql_fetch_array($ph))
{
   $src=$row1[0];
   echo "<img src='$src' width ='250' height='250'>"."<br/>"."&nbsp"."&nbsp"."&nbsp"."&nbsp"."<p style=\"font-family:verdana;font-size:80%;color:CC0066\">".$row1[4]."<p style=\"font-family:verdana;font-size:80%;color:9999CC\">".
   $row1[1]."&nbsp"."&nbsp"."&nbsp"."&nbsp".$row1[2]."&nbsp"."&nbsp"."&nbsp"."&nbsp".$row1[3]."<br/>"."&nbsp"."&nbsp"."&nbsp"."&nbsp".$row1[5]."<br/>".
   "<a href=\"pdelete.php?pid=".$row1[1]."\">"."<p style=\"font-family:verdana;font-size:60%;color:black\">DELETE</a>";
   echo "<br/>";
   echo "<br/>";
}
